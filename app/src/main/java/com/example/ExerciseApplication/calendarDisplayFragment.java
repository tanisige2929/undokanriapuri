...
public class calendarDisplayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calendar_display, container, false);
        viewpager = view.findViewById(R.id.pager);
        viewpager.setAdapter(new FragmentCalendarAdapter(getActivity().getSupportFragmentManager(), getActivity()));
